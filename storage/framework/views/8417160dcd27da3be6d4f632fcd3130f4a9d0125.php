    ...
    <div class="container">
        <div class="registerbox">
            ...
            <input type="hidden" name="_token" value="<?php echo csrf_token();?>">
                ...
                <input type="text" class="form-control" name="txtshopName" id="txtshopName" placeholder="Full Name" autofocus="autofocus"/><br>
                ...
                <p>Image : </p><input type="file" name="shopProof" id="shopProof">
