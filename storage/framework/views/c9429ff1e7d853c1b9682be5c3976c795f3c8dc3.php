...
<div class="container">
  ...
  <div class="menuGroup">
    <img class="ico" src="/uploads/icons/shopping-cart.png" alt="cart Image" onclick="cartView()">
    <br><br>
    <img class="ico" src="/uploads/icons/editProfile.png" alt="editProfile Image" onclick="editProfile()">
  </div>
  <div class="clearBoth"></div>
</div>
<script type="text/javascript">
 ...
 {
  window.location = "/userEditProfile";
 }
</script>
</body>
</html>